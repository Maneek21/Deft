...
const EXTRA_WIKI: SeedWiki2[] = [
  ...
  {
    type: 'fact',
    title: 'Deft license — GNU AGPL v3',
    slug: 'fact-deft-license-agpl',
    summary: 'Deft is open source under GNU AGPL v3.0 only, including its network Corresponding Source obligation.',
    content: '# License: GNU AGPL v3\n\n**SPDX identifier:** `AGPL-3.0-only`\n**License file:** `LICENSE`\n\n## What you can do\n- Run and study the code\n- Modify it\n- Redistribute source and object forms under the license terms\n- Use it commercially under the license terms\n\n## Network source obligation\nIf you modify Deft and let users interact with that version over a network, section 13 requires you to offer those users its Corresponding Source. Set `DEFT_SOURCE_CODE_URL` to that exact source. The self-hosted v1 one-workspace boundary is a product limitation, not a license restriction.\n\nSee `LICENSE` for the complete terms.',
    confidence: 0.99,
    daysAgo: 20,
  },
  {
